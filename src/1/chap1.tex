...
Le coaxial utilisé a généralement une impédance caractéristique de 50\textOmega{} et une longueur de 5 mètres, correspondant à un délai de 50ns de propagation.
...
\begin{figure}[!h]
  ...
  \caption{Minimal exemple of a \gls{tlp} system}
  \label{tlp_concept}
\end{figure}
